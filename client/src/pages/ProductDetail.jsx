    ...
    <section className="wrap section">
      ...
      <div className="grid grid-2" style={{ marginTop: 22, alignItems: 'start' }}>
        ...
        <div className="stack">
          ...
          <div className="row">
            <button className="btn btn-ghost" disabled={out} onClick={() => handleBuy('/cart')}>
              {t('addToCart')}
            </button>
            <button className="btn" disabled={out} onClick={() => handleBuy('/checkout')}>
              {t('buyNow')} →
            </button>
          </div>
        </div>
