...
export default function Home() {
  ...
  return (
    <>
      <section className="wrap section" style={{ display: 'grid', gridTemplateColumns: '1.05fr 0.95fr', gap: 48, alignItems: 'center' }}>
        <div className="stack">
      ...
      <section className="wrap section" style={{ paddingTop: 0 }}>
        <div className="card" style={{ padding: 24, marginBottom: 22, background: 'linear-gradient(135deg, oklch(0.19 0.014 265 / 0.96), oklch(0.24 0.018 265 / 0.96))', boxShadow: 'var(--shadow)' }}>
          <div className="spread" style={{ marginBottom: 14 }}>
            <div>
              <div className="label" style={{ marginBottom: 8 }}>{t('shop')}</div>
              <h2 style={{ fontSize: 'clamp(24px, 3vw, 34px)' }}>Live account inventory</h2>
            </div>
            <Link to="/shop">{t('browse')} →</Link>
          </div>
          <p className="muted" style={{ maxWidth: 700, lineHeight: 1.6 }}>Browse premium plans, 4K and 8K accounts, bundles, and secure access options instantly — with a smooth purchase flow once you sign in.</p>
        </div>
