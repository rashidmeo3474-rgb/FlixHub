...
export default function Home() {
  ...
  const FALLBACK_CARDS = {
    ...
    'prime-video':    { _id: 'prime-video',    slug: 'prime-video',    name: 'Prime Video',           accent: '#00a8e1', monthlyPrice: 350,  compareAt: 500,  inStock: 8, quality: '1080p HD', logo: '/logos/prime-video-new.png'   },
    ...
    'hbo-max':        { _id: 'hbo-max',        slug: 'hbo-max',        name: 'HBO Max',               accent: '#9b30ff', monthlyPrice: 450,  compareAt: 600,  inStock: 8, quality: '1080p HD', logo: '/logos/hbo-max-new.png'       },
  };
